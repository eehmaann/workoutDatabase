    ...
    <cfinclude template = "header.cfm">
      ...
      <cfif showCondition.RecordCount is 0>
       ...
       <cfelse>
        ...
        <cfform action="addCondition.cfm" method="post" scriptSrc="http://cscie60.dce.harvard.edu:8500/CFIDE/scripts/" perservedata ="Yes">
        Name the condition<cfinput type="text" size="100" name="conName" 
        required="yes" message="Include a description for further use, under 100 characters">
Hours Slept: <cfinput type="text" size="2" name="sleep" 
        validate="range" range="0,24" required="Yes" 
        message="You must list how many full hours of sleep are you getting under this condition."><br>
Are you experiencing any sickness or feeling healthy?<cfinput type="text" size="50" name=" sickness " 
        required="yes" message="State any sickness or type feeling well.  Use up to 50 characters"><br>
Describe most pertinent injury, or type no injuries?<cfinput type="text" size="50" name="mainInjury" 
        required="yes" message="This is required.  Use up to 50 characters"><br>
