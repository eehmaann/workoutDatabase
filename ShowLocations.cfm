   ...
   <body>
    	<cfinclude template = "header.cfm">
     	<cfif showSession.RecordCount is 0>
    		You will need to have at least one <a href="ShowCoaches.cfm"> Coach</a>,
            one <a href="ShowLocations.cfm"> Location </a>, 
            one <a href="ShowCondition.cfm"> Condition </a>  
            and one <a href="ShowWorkout.cfm" Workout</a> 
            recorded before you can record a session
      	</cfif>
		<cflayout type="accordion" height="400">
			...
			<cflayoutarea title="Add Location">
            	...
            	<div class="aform">
                	...
                	<cfform action="addLocation.cfm" method="post" 
                	scriptSrc="http://cscie60.dce.harvard.edu:8500/CFIDE/scripts/"
                 	perservedata ="Yes"> 

						Location Name: 
                        <cfinput type="text" size="100" name="locName" 
                        required="yes" message="What are you calling
                        the location? Only use 100 characters"><br>

						What is the ground made of: 
                        <cfinput type="text" size="50" name="ground" required="yes"
                         message="What material is the ground made of? Required use
                         up to 50 characters"><br>
                    
						Describe Topology of the ground: 
                        <cfinput type="text" size="50" name="terrain" required="yes"
                        message="You must describe the topology of the ground 
                        under 50 characters."><br>
