<html>
   ...
   <body>
    ...
    <div class="aform">
   <p> Add a session</p>
        <cfform action="addSession.cfm" method="post" scriptSrc="http://cscie60.dce.harvard.edu:8500/CFIDE/scripts/" perservedata ="Yes">
       Which workout was this? <select name="workoutNo">
                <cfoutput query="emptySession">
                  <option value="#emptySession.workoutNo#">Date #emptySession.workdate# Lift #emptySession.liftType# #emptySession.load# Mile #emptySession.miles#</option>
                </cfoutput> 
              </select><br>
...
How were you doing?     <select name="conNo">
              ...
              Number in attendance: <cfinput type="text" size="6" name="attendance"
        validate="integer" required="Yes" 
        message="A number for attendance is required, up to 999999.">
Temperature: <cfinput type="text" size="3" name="temperature" 
        validate="integer" required="Yes" 
        message="Temperature must be an integer and at least an estimate is required"><br>    
