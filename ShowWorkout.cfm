<html>
 ...
 <cflayout type="accordion" height="400"> 
  ...
  <cfif showWorkout.RecordCount is 0>
  	<p>You need to add a workout before you can do anything else on the site.</p>
    <cfelse>
         ...
         <p> To completely add a new entry.  Provide the information about your workout on this page, then build <a href="ShowSession.cfm"> a session</a> to connect to it and record <a href="ShowMeasurements.cfm">your measurement</a>.  If you don't do those steps, the table will be missing fields, but it still works.  The date, will be the date you entered, so make sure to enter every day. </p>  <br>
        	<table>
              <tr> 
              <th>Perfomed on</th>
              ...
              <th> <a href="ShowMeasurements.cfm">Reported weight on the day was</a></th>
              </tr>
 ...
 <div class="aform">
 <p> Add a workout.</p>
 <cfform action="addWorkout.cfm" method="post" scriptSrc="http://cscie60.dce.harvard.edu:8500/CFIDE/scripts/" perservedata ="Yes">
              Miles: <cfinput type="text" size="5" name="miles" 
        validate="range" range="0,300" required="yes" message="Write the number of miles you ran, if none write 0"><br>
    Lift type: <cfinput type="text" size="80" name="liftType" 
        required="yes" message="You must type the kind of lift you practiced, or type none"><br>
     How much did you lift: <cfinput type="text" size="5" name="load" 
        validate="integer" range="0,9999" required="yes" message="You must type how much you lifted, if none, type 0"><br>
     What was your pace in miles per hours: <cfinput type="text" size="5" name="pace" 
    ...
    <cflayoutarea title="Edit Workout">
        <p> <a href="editingWorkout.cfm"> Does a workout need to be edited?</a></p>
        <p> Examine based upon coach
                	 <cfform action="WorkoutbyCoach.cfm" method="post" scriptSrc="http://cscie60.dce.harvard.edu:8500/CFIDE/scripts/" perservedata ="Yes">
    	   ...
    	   <cfoutput query="showCoaches">
                ...
                <cfform action="WorkoutbyCondition.cfm" method="post" scriptSrc="http://cscie60.dce.harvard.edu:8500/CFIDE/scripts/" perservedata ="Yes">
